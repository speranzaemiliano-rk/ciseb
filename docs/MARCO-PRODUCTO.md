...
| **2 — Agenda** | Catálogo con duraciones, sync Calendar, confirmación 24 h, notas de preferencia, lista de espera | 🟡 turno vinculado a duración/prestación con detección de solapamiento, **lista de espera con sugerencia automática al cancelar**, y **confirmación automática 24h por mail** ya cerradas; falta únicamente sync con Google Calendar |
