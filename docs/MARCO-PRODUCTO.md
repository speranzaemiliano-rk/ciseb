...
| **Turnos** / agenda | 🟡 | Listado filtrable por fecha/estado, con `id` estable, FK a paciente/profesional/prestación, duración/hora de fin y detección de solapamiento de horario (aviso no bloqueante). **Sin** sincronización con Google Calendar ni confirmación automática 24 h. |
...
| **2 — Agenda** | Catálogo con duraciones, sync Calendar, confirmación 24 h, notas de preferencia, lista de espera | 🟡 turno vinculado a duración/prestación con detección de solapamiento, y **lista de espera con sugerencia automática al cancelar** ya cerradas; falta sync con Google Calendar y confirmación automática 24 h |
