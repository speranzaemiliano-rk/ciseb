...
| **4 — Planes y consentimientos** | Presupuestos por etapas, aceptación, consentimiento con firma+evidencia, bloqueo de evolución sin consentimiento | 🟡 **consentimiento con firma+evidencia y bloqueo real, listos.** Falta presupuestos por etapas con aceptación del paciente (hoy Planes de Tratamiento es la versión liviana de Fase 3, sin etapas). |
